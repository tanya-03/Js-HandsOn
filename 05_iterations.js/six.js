...
const newNums = myNums.filter( (num) =>  (num > 4) )         // agr curly brace use krni hai toh return likhna padega else () use krlo direct yeh same chiz 03_Basics ke arrow mei use kiya hai
console.log(newNums);
